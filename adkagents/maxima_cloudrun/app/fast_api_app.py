...
DEFAULT_AGENT_ENGINE_SESSION_NAME = "maxima-cloudrun-sessions"
...
app.title = "maxima-cloudrun-canary"
app.description = "Cloud Run ADK runtime for the Maxima canary agent."
