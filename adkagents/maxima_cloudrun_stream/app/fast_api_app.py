"""Cloud Run FastAPI entrypoint for the Maxima streaming ADK canary."""
...
DEFAULT_AGENT_ENGINE_SESSION_NAME = "maxima-cloudrun-stream-sessions"
...
app.title = "maxima-cloudrun-stream"
app.description = "Cloud Run ADK runtime for the Maxima streaming canary agent."
